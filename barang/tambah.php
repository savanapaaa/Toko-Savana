...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $check_query = "SELECT id_barang FROM barang WHERE nama_barang = '" . escape_string($nama_barang) . "'";
    ...
    if (empty($errors)) {
        $insert_query = "INSERT INTO barang (nama_barang, harga, stok) VALUES ('" . 
                       escape_string($nama_barang) . "', " . 
                       floatval($harga) . ", " . 
                       intval($stok) . ")";
...
<head>
    ...
    <title>Tambah Barang - Toko Savana</title>
...
<body class="bg-light">
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h4 class="mb-0">
                            <i class="fas fa-plus-circle me-2"></i> Form Tambah Barang
                        </h4>
                    </div>
                    <div class="card-body">
                        <!-- Alert Messages -->
                        ...
                        <!-- Form -->
                        <form method="POST" id="tambah-barang-form">
                            <div class="mb-3">
    ...
    <script>
        ...
        // Form validation
        document.getElementById('tambah-barang-form').addEventListener('submit', function(e) {
