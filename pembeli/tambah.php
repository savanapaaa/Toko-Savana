...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $check_query = "SELECT id_pembeli FROM pembeli WHERE nama_pembeli = '" . escape_string($nama_pembeli) . "'";
    ...
    if (empty($errors)) {
        $insert_query = "INSERT INTO pembeli (nama_pembeli, alamat) VALUES ('" . 
                       escape_string($nama_pembeli) . "', '" . 
        ...
        if ($conn->query($insert_query)) {
            ...
            $errors[] = "Gagal menambahkan pembeli: " . $conn->error;
        }
    }
}
?>
...
<head>
    ...
    <title>Tambah Pembeli - Toko Savana</title>
...
<body class="bg-light">
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h4 class="mb-0">
                            <i class="fas fa-user-plus me-2"></i> Form Tambah Pembeli
                        </h4>
                    </div>
                    <div class="card-body">
                        <!-- Alert Messages -->
                        ...
                        <!-- Form -->
                        <form method="POST" id="tambah-pembeli-form">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="alamat" name="alamat" rows="4" 
                                          placeholder="Masukkan alamat lengkap pembeli" required><?= htmlspecialchars($alamat ?? '') ?></textarea>
                                <div class="form-text">
                            ...
                            <div class="card bg-light mb-3" id="preview-card" style="display: none;">
                                <div class="card-header">
                                    <small class="text-muted"><i class="fas fa-eye"></i> Preview</small>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <button type="submit" class="btn btn-success w-100">
                                        <i class="fas fa-save"></i> Simpan Pembeli
                                    </button>
                                </div>
                            </div>
                        </form>
    ...
    <script>
        ...
        // Form validation
        document.getElementById('tambah-pembeli-form').addEventListener('submit', function(e) {
            const nama = document.getElementById('nama_pembeli').value.trim();
            const alamat = document.getElementById('alamat').value.trim();
