...
// Get barang options with stock
$barang_query = "SELECT * FROM barang WHERE stok > 0 ORDER BY nama_barang ASC";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($id_barang > 0) {
        ...
        if ($check_barang->num_rows == 0) {
            ...
            if ($barang_data['stok'] < $jumlah) {
                $errors[] = "Stok tidak mencukupi! Stok tersedia: " . $barang_data['stok'] . " unit";
            }
        }
    }
    ...
    if (empty($errors)) {
        ...
        try {
            // Insert transaksi
            $insert_query = "INSERT INTO transaksi (id_pembeli, id_barang, jumlah, total_harga, tanggal) 
                            VALUES ($id_pembeli, $id_barang, $jumlah, $total_harga, '$tanggal')";
            ...
            $conn->rollback();
            $errors[] = "Gagal menambahkan transaksi: " . $e->getMessage();
        }
...
<head>
    ...
    <title>Tambah Transaksi - Toko Savana</title>
...
<body class="bg-light">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <!-- Form -->
                                <form method="POST" id="tambah-transaksi-form">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="id_pembeli" name="id_pembeli" required>
                                            ...
                                            <?php while ($pembeli = $pembeli_result->fetch_assoc()): ?>
                                                <option value="<?= $pembeli['id_pembeli'] ?>" 
                                                        <?= (isset($id_pembeli) && $id_pembeli == $pembeli['id_pembeli']) ? 'selected' : '' ?>>
                                        ...
                                        <div class="form-text">
                                            ...
                                            Tidak ada pembeli? <a href="../pembeli/tambah.php" target="_blank">Tambah pembeli baru</a>
                                        </div>
                                    </div>
                                        ...
                                        <select class="form-select" id="id_barang" name="id_barang" required>
                                            ...
                                            <?php while ($barang = $barang_result->fetch_assoc()): ?>
                                                <option value="<?= $barang['id_barang'] ?>" 
                                                    ...
                                                    (Stok: <?= $barang['stok'] ?> | <?= format_rupiah($barang['harga']) ?>)
                                                </option>
                                            <?php endwhile; ?>
                                        </select>
                                        <div class="form-text">
                                            <i class="fas fa-info-circle"></i> 
                                            Hanya menampilkan barang yang memiliki stok
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <!-- Stock Info -->
                                <div class="card mt-3" id="stock-card" style="display: none;">
                                    <div class="card-header">
    ...
    <script>
        ...
        // Form validation
        document.getElementById('tambah-transaksi-form').addEventListener('submit', function(e) {
